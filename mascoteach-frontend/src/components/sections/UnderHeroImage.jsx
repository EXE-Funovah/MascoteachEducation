...
export default function UnderHeroImage() {
  ...
  return (
    <section
      className="relative z-20 px-3 pb-20 text-[#173154] sm:px-5 md:pb-24 lg:px-8 lg:pb-28 xl:pb-32"
    ...
    >
      ...
      >
        <div className="grid gap-8 lg:grid-cols-[minmax(0,0.59fr)_minmax(440px,0.41fr)] lg:items-center lg:gap-12 xl:gap-16">
          <div>
            <div className="inline-flex items-center gap-2 rounded-full border border-[#BBDCFB] bg-[#F7FAFF] px-3.5 py-2 text-sm font-bold text-[#4F92DD]">
            ...
            <h2
              ...
              className="mt-5 max-w-[760px] text-[clamp(2rem,3.4vw,4rem)] font-black leading-[1.08] tracking-normal text-[#173154]"
            >
              Biến tài liệu học tập thành{' '}
              <span className="text-[#5E8FF2]">trò chơi tương tác</span> cùng Sumadi
            </h2>

            <p className="mt-6 max-w-[660px] text-base font-medium leading-8 text-[#2F3D52] sm:text-lg">
            ...
            <div className="mt-6 flex flex-col gap-3 sm:flex-row">
              <Link
                to="/register"
                className="inline-flex h-12 items-center justify-center gap-3 rounded-full bg-[#5E8FF2] px-7 text-base font-bold text-white shadow-[0_12px_28px_rgba(94,143,242,0.22)] transition-all duration-200 hover:-translate-y-0.5 hover:bg-[#4F7FE0] active:scale-[0.98]"
              >
                Bắt đầu miễn phí
              ...
              <Link
                to="/product"
                className="inline-flex h-12 items-center justify-center gap-3 rounded-full border border-[#8DBEF2] bg-white px-7 text-base font-bold text-[#173154] transition-all duration-200 hover:-translate-y-0.5 hover:border-[#6DA6E8] hover:bg-[#F7FAFF] active:scale-[0.98]"
              >
                Xem cách hoạt động
                <ArrowRight className="h-4 w-4" aria-hidden="true" />
              </Link>
            ...
            <motion.article
              className="mt-6 grid max-w-[620px] grid-cols-[104px_1fr] items-center gap-4 rounded-[22px] border border-[#BBDCFB] bg-[#FBFDFF] p-4 md:grid-cols-[128px_1fr] md:p-5"
              initial={reveal}
              whileInView={visible}
            ...
            >
              ...
              <div>
                <h3 className="text-lg font-extrabold leading-snug text-[#5E8FF2]">
                  Xin chào! Mình là Sumadi
                </h3>
                <p className="mt-2 text-sm font-medium leading-6 text-[#2F3D52] sm:text-base">
