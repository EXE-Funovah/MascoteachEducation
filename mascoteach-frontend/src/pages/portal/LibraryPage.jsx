...
export default function LibraryPage() {
  ...
  return (
    <>
      <div className="space-y-8">
        ...
        <div className="flex items-center gap-1 border-b border-slate-100 pb-0">
          {LIBRARY_TABS.map((tab) => {
            ...
            const count =
              tab.id === "documents" ? documents.length : quizzes.length;
            return (
              <button
                key={tab.id}
              ...
              >
                ...
                {tab.label}
                {(!loadingDocs && tab.id === "documents") ||
                (!loadingQuizzes && tab.id === "quizzes") ? (
                  <span
                    className={`ml-1 inline-flex items-center justify-center min-w-[20px] h-5 px-1.5
                      ...
                      >
                        ...
                        <div className="flex items-center justify-between p-5">
                          ...
                          >
                            ...
                            >
                              <BookOpen
                                className={`w-[18px] h-[18px] ${isExpanded ? "text-sky-600" : "text-violet-500"}`}
                              />
                            </div>
                            <div className="min-w-0">
      ...
      {/* ── Create Flow Modal ── */}
      {showCreateModal && <CreateFlowModal onClose={handleModalClose} />}
    </>
  );
}
